...
function dosya_tasi($kaynak, $hedef) {
    return move_uploaded_file($kaynak, $hedef);
}
...
<head>
    ...
    <title></title>
    <script>
        // JavaScript ile enctype özelliðini ayarlama
        window.onload = function() {
            document.getElementById('f').parentElement.enctype = 'multipart/form-data';
        };
    </script>
</head>
<body>
