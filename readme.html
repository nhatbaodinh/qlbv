...
- [The WordPress Blog](https://wordpress.org/news/): Where you’ll find the latest updates and news related to WordPress. Recent WordPress news appears in your administrative dashboard by default.
...
- [WordPress Support Forums](https://wordpress.org/support/forums/): If you’ve looked everywhere and still cannot find an answer, the support forums are very active and have a large community ready to help.
- [WordPress IRC Channel](https://make.wordpress.org/support/handbook/appendix/other-support-locations/introduction-to-irc/): An online chat channel for WordPress users and occasional support topics. (irc.libera.chat #wordpress)
...
- WordPress has a robust plugin [API](https://developer.wordpress.org/plugins/) (Application Programming Interface) that makes extending the code easy. You shouldn’t modify any of the core code.
